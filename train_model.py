...
# split the provided data to have a train dataset and a test dataset using the same random_state as the model
# stratified based on the salary column in the dataset
...
# fit encoder/lb on the training split
